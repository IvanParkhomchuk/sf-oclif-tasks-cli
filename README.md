...
<!-- usage -->
```sh-session
$ npm install -g @ivanparkhomchuk/tasks-cli
$ tasks COMMAND
running command...
$ tasks (--version)
@ivanparkhomchuk/tasks-cli/0.0.0 win32-x64 node-v16.17.0
$ tasks --help [COMMAND]
USAGE
  $ tasks COMMAND
...
...
* [`tasks help [COMMANDS]`](#tasks-help-commands)
...
_See code: [dist/commands/hello/index.ts](https://github.com/IvanParkhomchuk/tasks-cli/blob/v0.0.0/dist/commands/hello/index.ts)_
